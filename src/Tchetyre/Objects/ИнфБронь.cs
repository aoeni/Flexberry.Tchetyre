...
namespace IIS.Tchetyre
{
    ...
    [View("ИнфБроньE", new string[] {
            ...
            "Пассажир.ФИО as \'ФИО\'",
            "Пассажир.КодБрони.Код as \'КодБрони\'",
    ...
    public class ИнфБронь : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tchetyre.Пассажир fПассажир;
        
        private IIS.Tchetyre.Рейс fРейс;
        ...
        [PropertyStorage(new string[] {
                "Пассажир"})]
        [NotNull()]
        public virtual IIS.Tchetyre.Пассажир Пассажир
        {
            get
            {
                ...
                IIS.Tchetyre.Пассажир result = this.fПассажир;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Tchetyre.Рейс.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Рейс"})]
        public virtual IIS.Tchetyre.Рейс Рейс
        {
            get
            {
                ...
                IIS.Tchetyre.Рейс result = this.fРейс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ИнфБроньE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИнфБроньE", typeof(IIS.Tchetyre.ИнфБронь));
                }
            }
        }
    }
    ...
    public class DetailArrayOfИнфБронь : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Tchetyre.DetailArrayOfИнфБронь members)

        // *** End programmer edit section *** (IIS.Tchetyre.DetailArrayOfИнфБронь members)
        ...
        /// </summary>
        public DetailArrayOfИнфБронь(IIS.Tchetyre.Рейс fРейс) : 
                base(typeof(ИнфБронь), ((ICSSoft.STORMNET.DataObject)(fРейс)))
        {
        }
        
        public IIS.Tchetyre.ИнфБронь this[int index]
        {
            get
            {
                return ((IIS.Tchetyre.ИнфБронь)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Tchetyre.ИнфБронь dataobject)
        {
