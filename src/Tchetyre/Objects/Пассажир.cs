...
namespace IIS.Tchetyre
{
    ...
    public class Пассажир : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tchetyre.МестоНаРейс fМестоНаРейс;
        
        private IIS.Tchetyre.КодБрони fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "КодБрони"})]
        [NotNull()]
        public virtual IIS.Tchetyre.КодБрони КодБрони
        {
            get
            {
                ...
                IIS.Tchetyre.КодБрони result = this.fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "МестоНаРейс"})]
        [NotNull()]
        public virtual IIS.Tchetyre.МестоНаРейс МестоНаРейс
        {
            get
            {
                ...
                IIS.Tchetyre.МестоНаРейс result = this.fМестоНаРейс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПассажирE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирE", typeof(IIS.Tchetyre.Пассажир));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПассажирL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирL", typeof(IIS.Tchetyre.Пассажир));
                }
            }
        }
    }
