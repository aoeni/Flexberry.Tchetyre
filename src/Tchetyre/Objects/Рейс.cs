...
namespace IIS.Tchetyre
{
    ...
    public class Рейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tchetyre.DetailArrayOfИнфБронь fИнфБронь;
        ...
        public virtual IIS.Tchetyre.DetailArrayOfИнфБронь ИнфБронь
        {
            get
            {
                ...
                {
                    this.fИнфБронь = new IIS.Tchetyre.DetailArrayOfИнфБронь(this);
                }
                IIS.Tchetyre.DetailArrayOfИнфБронь result = this.fИнфБронь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсE", typeof(IIS.Tchetyre.Рейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсL", typeof(IIS.Tchetyre.Рейс));
                }
            }
        }
    }
